...
(define-abbrev-table 'c-mode-abbrev-table
  '(
    ("debug" "" skel-c-dbg-print 12)
    ("debugh" "" skel-c-dbg-hexdump 9)
    ("printf" "" skel-c-printf 2)
   ))
...
(define-abbrev-table 'verilog-mode-abbrev-table
  '(
    ("debug" "" skel-verilog-insert-uvm-info 5)
    ("debugp" "" skel-verilog-insert-uvm-info-with-psprintf 3)
    ("uvm_info" "" skel-verilog-insert-uvm-info 3)
    ("uvm_infop" "" skel-verilog-insert-uvm-info-with-psprintf 2)
   ))
